...
namespace EveWebClient.SSO.Models
{
    public class APIBase
    {
        ...
        internal async Task<APIResponse> GetAsync(string uri, AccessTokenDetails auth, string ifNoneMatch = null, Dictionary<string, string> queryParameters = null)
        {
            return await RequestAsync(HttpMethod.Get, uri, auth, ifNoneMatch, queryParameters);
        }

        internal async Task<APIResponse> PostAsync(string uri, AccessTokenDetails auth, object body, string ifNoneMatch = null, Dictionary<string, string> queryParameters = null)
        {
            return await RequestAsync(HttpMethod.Post, uri, auth, ifNoneMatch, queryParameters, body);
        }

        internal async Task<APIResponse> PutAsync(string uri, AccessTokenDetails auth, object body, Dictionary<string, string> queryParameters = null)
        {
            return await RequestAsync(HttpMethod.Put, uri, auth, null, queryParameters, body);
        }

        internal async Task<APIResponse> DeleteAsync(string uri, AccessTokenDetails auth, Dictionary<string, string> queryParameters = null)
        {
        ...
        private async Task<APIResponse> RequestAsync(HttpMethod method, string uri, AccessTokenDetails auth, string ifNoneMatch = null, Dictionary<string, string> queryParameters = null, object body = null)
        {
            ...
            try
            {
                ...
                {
                    if (auth.ExpiresUtc > DateTime.UtcNow)
                    {
